...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h3>{{ __('Доб новости') }}</h3></div>
                <div class="card-body">
                    
                <form action ="{{ route('news.store', $news)}}" method='post'>
...
<br>
<div class="form-group">
<input type="submit" class="btn btn-outline-primary" value=доб новость">
